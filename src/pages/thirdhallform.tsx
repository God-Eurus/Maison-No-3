          ...
          {step === 1 && (
            <div>
              ...
              <fieldset className="mb-12">
                ...
                <input type="text" required className={inputClass} placeholder="Your legal or public name" />

                <label className={labelClass}>2. Preferred Name</label>
                <input type="text" className={inputClass} placeholder="How you wish to be addressed" />

                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className={labelClass}>3. City of Influence *</label>
                    <input type="text" required className={inputClass} placeholder="Primary city" />
                  </div>
                  <div>
                    <label className={labelClass}>4. Country *</label>
                    <input type="text" required className={inputClass} placeholder="Primary country" />
                  </div>
                </div>
                ...
                <input type="text" required className={inputClass} placeholder="The code extended to you" />

                <label className={labelClass}>7. Inviting Signatory (Optional)</label>
                <input type="text" className={inputClass} placeholder="Name of your referrer" />
              </fieldset>
          ...
          {step === 2 && (
            <div>
              ...
              <fieldset className="mb-12">
                 ...
                 <select multiple required className={`${inputClass} h-32 py-2`} style={{ scrollbarWidth: 'none' }}>
                 ...
                 <textarea required rows={4} className={`${inputClass} resize-none`} placeholder="What influence do you hope to carry forward?"></textarea>
              </fieldset>
          ...
          {step === 3 && (
            <div>
               ...
               <fieldset className="mb-12">
                ...
                <input type="text" required className={inputClass} placeholder="Handle, number, or address" />
                ...
                <input type="text" className={inputClass} placeholder="E.g., London, Tokyo, New York" />
              </fieldset>
          ...
          {step === 4 && (
            <div>
               ...
               <fieldset className="mb-12">
                  ...
                  <textarea rows={2} className={`${inputClass} resize-none`} placeholder="Rare but meaningful additions"></textarea>
               </fieldset>

               <fieldset className="mb-16 border-t border-[#d6c5b3]/20 pt-12">
                 <label className="flex items-start gap-4 cursor-pointer group">
                    <div className="relative flex items-center justify-center mt-1">
                      <input type="checkbox" required className="peer appearance-none w-5 h-5 border border-[#d6c5b3]/50 checked:bg-[#d6c5b3] transition-colors cursor-pointer" />
              ...
              <div className="flex justify-center mt-8">
                <button type="submit" className="border border-[#d6c5b3]/50 py-4 px-12 tracking-[0.4em] text-xs uppercase hover:bg-[#d6c5b3] hover:text-[#1c1311] transition-all duration-500 hover:shadow-[0_0_15px_rgba(214,197,179,0.2)]">
                  Enter the Record
                </button>
              </div>
            </div>
